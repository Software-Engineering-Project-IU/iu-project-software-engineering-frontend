...
const HelpRequests = ({ userName }) => {
    ...
    return (
        <div>
            ...
            {isHelpVisible && currentUser && currentUser.helpRequests && currentUser.helpRequests.length > 0 ? (
                        ...
                        {request.providedHelp && (
                            <div className='home'>
                                ...
                                <div className='buttons-help-request'>
                                    ...
                                    <Button text={"Nicht hilfreich"} buttonColor='button-secondary' onClick={handleUnhelpful}/>
                                </div>
                            </div>
                        )}
                    </div>
